class CompetitorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @competitor.save
        format.html { redirect_to @competitor, notice: 'Gracias por Participar' }
  ...
  private
    ...
    def competitor_params
      params.require(:competitor).permit(:name, :last_name, :identification, :town_id, :cellphone, :email, :habeas_data)
    end
end
